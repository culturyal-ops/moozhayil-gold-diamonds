...
const goldenWishPlans = <GoldenWishPlan>[
  GoldenWishPlan(
    ...
    summary: '11 monthly installments from ₹500 — gold credited at each payment.',
  ...
  GoldenWishPlan(
    ...
    summary: 'Book today — receive the lower of booking or redemption day rate.',
