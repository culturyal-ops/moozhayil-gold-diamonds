...
const homeCategories = <HomeCategory>[
  ...
  HomeCategory(name: 'Pendant', imageKey: 'ginkgo', subtitle: 'Everyday & gifting'),

  HomeCategory(name: 'Necklace', imageKey: 'celeste', subtitle: 'Temple, bridal & daily wear'),

  HomeCategory(name: 'Bangle', imageKey: '1611107683227-e9060eccd846', subtitle: 'Classic gold bangles'),

  HomeCategory(name: 'Ring', imageKey: 'band', subtitle: 'Bands & solitaires'),

  HomeCategory(name: 'Earrings', imageKey: 'luna', subtitle: 'Studs, hoops & jhumkas'),

  HomeCategory(name: 'Bridal', imageKey: 'temple', subtitle: 'Wedding collections'),

  HomeCategory(name: 'Diamond', imageKey: '1605100804763-247f67b3557e', subtitle: 'Certified stones'),

  HomeCategory(name: 'Silver', imageKey: '1611591437281-460bfbe1220a', subtitle: 'Silver & fusion'),
